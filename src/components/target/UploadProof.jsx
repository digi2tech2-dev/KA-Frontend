  ...
  return (
    <div>
      ...
      <div
        ...
        className={cn(
          'relative overflow-hidden rounded-[1.25rem] border border-dashed border-[color:rgb(var(--color-primary-rgb)/0.32)] bg-[color:rgb(var(--color-card-rgb)/0.7)] p-3 text-center transition-all duration-200',
          isDragging && 'scale-[1.01] border-[color:rgb(var(--color-primary-rgb)/0.72)] bg-[color:rgb(var(--color-primary-rgb)/0.09)]'
        )}
      >
        {value?.preview ? (
          <div className="grid items-center gap-4 sm:grid-cols-[8rem_1fr] sm:text-start">
            <img
              ...
              className="h-28 w-full rounded-[1rem] border border-[color:rgb(var(--color-primary-rgb)/0.2)] object-cover"
            />
            <div className="flex min-w-0 flex-col justify-center gap-3">
              <div className="min-w-0">
                <p className="flex items-center gap-1.5 text-xs font-bold text-[var(--color-primary)]">
          ...
          <button
            ...
            className={cn(
              'group flex w-full flex-col items-center justify-center rounded-[1rem] px-3 transition hover:bg-[color:rgb(var(--color-primary-rgb)/0.06)]',
              compact ? 'py-3' : 'py-6 sm:py-7'
            )}
          >
            <span className={cn(
              'flex items-center justify-center rounded-2xl bg-[color:rgb(var(--color-primary-rgb)/0.11)] text-[var(--color-primary)] transition-transform group-hover:-translate-y-0.5',
