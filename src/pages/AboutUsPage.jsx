  ...
  const featureCards = [
    {
      ...
      cardClass: 'border-cyan-300/70 bg-cyan-50 text-cyan-950 shadow-cyan-200/70 dark:border-cyan-400/22 dark:bg-cyan-400/10 dark:text-cyan-50 dark:shadow-cyan-950/20',
      iconClass: 'bg-cyan-500 text-white shadow-cyan-300/70 dark:bg-cyan-400 dark:text-cyan-950 dark:shadow-cyan-400/20',
    },
    {
      icon: CheckCircle2,
